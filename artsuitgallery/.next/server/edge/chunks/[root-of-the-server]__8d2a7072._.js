...
async function middleware(request) {
    ...
    if (path.startsWith('/admin') && path !== '/admin/login') {
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["verify"])(token, process.env.JWT_SECRET || 'default-secret-key');
